        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 min-h-[600px]">
          ...
          <div className="bg-slate-50 p-6 sm:p-10 flex items-center justify-center">
            <div className="w-full max-w-md text-center">
              ...
              <form className="mt-8 grid gap-4 text-left" onSubmit={(e) => { e.preventDefault(); if (!loading && !forgotPasswordLoading) { showForgotPassword && !isSignUp ? handleForgotPassword(e) : handlePrimary() } }}>
                {showForgotPassword && !isSignUp ? (
                  <div>
                ...
                <button type="submit" disabled={loading || forgotPasswordLoading} className={`mt-2 inline-flex items-center justify-center rounded-md px-4 py-2 text-white font-medium ${(loading || forgotPasswordLoading) ? 'bg-green-600/60 cursor-not-allowed' : 'bg-green-700 hover:bg-green-800'}`}>
                  {showForgotPassword && !isSignUp ? 
